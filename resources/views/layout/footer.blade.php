    ...
    <div class="global-page-container">
        ...
        <div class="small-11 small-centered large-12 columns footer-section">
            ...
            <div class="follow-us small-5 medium-3 small-offset-1 medium-offset-0 columns">
                <h4 class="{{asset('footer-section-title')}}">Siga-nos</h4>
                <a href="{{asset('http://www.facebook.com')}}"><img src="{{asset('img/social-icons/facebook.svg')}}" alt="facebook-icon"></a>
                <a href="{{asset('http://www.twitter.com')}}"><img src="{{asset('img/social-icons/twitter.svg')}}" alt="facebook-icon"></a>
                <a href="{{asset('http://www.instagram.com')}}"><img src="{{asset('img/social-icons/twitter.svg')}}" alt="facebook-icon"></a>
            </div>
...
<script src="resouces/js/js/vendor/jquery.js"></script>
<script src="resouces/js/js/vendor/slick.min.js"></script>
<script src="resouces/js/js/scripts.js"></script>
<script src="resouces/js/js/foundation.min.js"></script>
<script>
    function initMap() {
